    ...
    return (
        <div className="content">
            <form action={onSubmit}>
                ...
                <Input value={filmeEdit.sinopse} onChange={(e) => handleFieldChange("sinopse", e.target.value)} name="sinopse" label="Sinopse" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eget ligula eu lectus lobortis condimentum. Aliquam nonummy auctor massa. Pellentesque habitant morbi." typeInput="textearea" />
                ...
                <Input value={filmeEdit.caminhoBanner} onChange={(e) => handleFieldChange("caminhoBanner", e.target.value)} name="caminhoBanner" label="Caminho da imagem" placeholder="harrypotter" />
